...
private _conso = 0.0015;  // fuel capacity = (((1/_conso) * 5) / 60) in minutes

if (_vehicle isKindOf "APC") then { _conso = 0.002 };
if (_vehicle isKindOf "Tank") then { _conso = 0.0025 };
if (_vehicle isKindOf "Air") then { _conso = 0.003 };
